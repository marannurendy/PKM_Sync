...
func GetToken() string {
	...
	data := url.Values{}
	data.Set("client_id", "KwQ7hMGS8FLb6XUKA0KDoWT0hJN4R7rL")
	data.Set("client_secret", "f507xZ6tWHJDq9Ss")
...
func (c *MainController) UpdateTransaction() models.TransactionUpdateResponse {
	...
	updateTransac := `UPDATE UMI_Referal
	...
	stmt, err := tx.Prepare(updateTransac)
	if err != nil {
	...
	if err != nil {
		...
		lastPoint := "https://sandbox.partner.api.bri.co.id/v1.0/umi/referral"
